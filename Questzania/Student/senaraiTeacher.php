...
<body>
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="card-header">
                        <div class="card">
                            <div class="card-body">
                                <button type="button" class="btn btn-success btn-animation waves-effect waves-light" data-text="Add Teacher" data-bs-toggle="modal" data-bs-target="#myModal"><span>Add Teacher</span></button>
                                <br>
                                <br>
                                <table class="table table-primary table-striped align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                                ...
                                                echo "
                                                    ...
                                                    <td >
                                                        <center>
                                                            ...
                                                            <a href='./Api/removeTeacher.php?userId=$userId' class='btn btn-danger btn-animation waves-effect waves-light data-text='Buang'>
                                                                Remove
                                                            </a>
                                                        </center>
                                                    </td>
                                                        ...
                                                        <div class='modal-dialog'>
                                                            <div class='modal-content'>
                                                                <div class='modal-header'>
                                                                    <h5 class='modal-title' id='myModalLabel'>Kemaskini Pelajar</h5>
                                                                    <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'> </button>
                                                                </div>
                                                                <form method='post' action='Api/updateTeacher.php'>
                                                                    <div class='modal-body'>
                                                                            ...
                                                                            <div class='col-md-12'>
                                                                                ...
                                                                                <input type='text' class='form-control' name='class' value='$namaKelas'  disabled>
                                                                            </div>
                                                                        <div class='col-md-12'>
                                            ...
                                            echo "
                                                <tr>
                                                <td colspan='9' align='center'>No Teacher Add</td>
                                                </tr>";
                                        }
                                        ?>
                                    </tbody>
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel">Add Teacher</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                </div>
                <form method='post' action='Api/addTeacher.php'>
                    <div class='modal-body'>
                        <h5 class='fs-15'>
