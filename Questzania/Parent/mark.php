                            ...
                            <div class="card-body">
                                <table class="table table-primary table-striped align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        LEFT JOIN profile p on p.user_id=profile.student_id
                                        LEFT JOIN kelas on kelas.id=p.kelas_id
                                        LEFT JOIN markah on markah.student_id=p.user_id AND markah.quiz_id=$quizId
                                        WHERE user.role='Parent' AND user.id='$uid' ";
