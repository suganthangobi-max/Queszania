            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php 
                        ...
                        $sql="SELECT count(*) as jumlah FROM user WHERE role='Student'";
                        $result = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
                        $jumlah = $row['jumlah'] ?? 0;
                      
                        $sql2="SELECT count(*) as jumlah FROM user WHERE role='Teacher'";
                        $result2 = mysqli_query($conn, $sql2);
                        $row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC);
                        $jumlah2 = $row2['jumlah'] ?? 0;
                        
                        $sql3="SELECT count(*) as jumlah FROM user WHERE role='Parent'";
                                            ...
                                            <div class="row row-cols-xxl-3 row-cols-md-3 row-cols-1 g-0">
                                                ...
                                                <div class="col">
                                                    <div class="mt-3 mt-md-0 py-4 px-3">
                                                        <h5 class="text-muted text-uppercase fs-13">Total Teacher</h5>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                ...
                                                <div class="col">
                                                    <div class="mt-3 mt-md-0 py-4 px-3">
                                                        <h5 class="text-muted text-uppercase fs-13">Total Parent</h5>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
