                            ...
                            <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                <form action="Api/editProfile.php" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="lastnameInput" class="form-label">I/C Number</label>
                                                <input type="text" class="form-control" name="noKp" placeholder="Masukkan No. K/P" value='<?php echo $noMatrik ?>'>
                                            </div>
                                        </div>
