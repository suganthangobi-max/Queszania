            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php 
                        ...
                        $sql="SELECT count(*) as jumlah FROM user JOIN profile ON profile.user_id=user.id AND profile.kelas_id='$kelas_id' WHERE role='Student'";
                        $result = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
                        $jumlah = $row['jumlah'] ?? 0;
                      
                        $sql2="SELECT count(*) as jumlah FROM nota WHERE kelas_id=$kelas_id";
                        $result2 = mysqli_query($conn, $sql2);
                        $row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC);
                        $jumlah2 = $row2['jumlah'] ?? 0;
                        
                        $sql3="SELECT count(*) as jumlah FROM quiz WHERE kelas_id=$kelas_id";
                        $result3 = mysqli_query($conn, $sql3);
                        $row3 = mysqli_fetch_array($result3, MYSQLI_ASSOC);
                        $jumlah3 = $row3['jumlah'] ?? 0;
                                            ...
                                            <div class="row row-cols-xxl-3 row-cols-md-3 row-cols-1 g-0">
                                                    ...
                                                    <div class="py-4 px-3">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h2 class="mb-0"><span class="counter-value" data-target="<?php echo $jumlah?>">0</span></h2>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- end col -->
                                                <div class="col">
                                                    <div class="mt-3 mt-md-0 py-4 px-3">
                                                        <h5 class="text-muted text-uppercase fs-13">Total Note</h5>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <i class="ri-exchange-dollar-line display-6 text-muted"></i>
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                                <h2 class="mb-0"><span class="counter-value" data-target="<?php echo $jumlah2; ?>">0</span></h2>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- end col -->
                                                <div class="col">
                                                    <div class="mt-3 mt-md-0 py-4 px-3">
                                                        <h5 class="text-muted text-uppercase fs-13">Total Quiz</h5>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <i class="ri-pulse-line display-6 text-muted"></i>
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                                <h2 class="mb-0"><span class="counter-value" data-target="<?php echo $jumlah3;?>">0</span></h2>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- end col -->
