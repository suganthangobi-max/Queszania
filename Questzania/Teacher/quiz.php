...
<body>
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="card-header">
                        <div class="card">
                            <div class="card-body">
                                <button type="button" class="btn btn-success btn-animation waves-effect waves-light" data-text="Add Quiz" data-bs-toggle="modal" data-bs-target="#myModal"><span>Add Quiz</span></button>
                                <br>
                                <br>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "
                                                    ...
                                                    <td >
                                                        <center>
                                                            <button type='button' class='btn btn-primary btn-animation waves-effect waves-light data-text='Update' data-bs-toggle='modal' data-bs-target='#view3$modal'>
                                                                Update
                                                            </button>
                                                            <a href='./Api/removeQuiz.php?id=$id' class='btn btn-danger btn-animation waves-effect waves-light data-text='Buang'>
                                                                Remove
                                                            </a>
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel">Add Quiz</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                </div>
                <form method='post' action='Api/addQuiz.php'>
                    <div class='modal-body'>
                        <h5 class='fs-15'>
